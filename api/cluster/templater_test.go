...
func TestCreateInferenceServiceSpec(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "custom spec with resource request - artifact exist",
			modelSvc: &models.Service{
				Name:        models.CreateInferenceServiceName(model.Name, "1"),
				Namespace:   project.Name,
				ArtifactURI: model.ArtifactURI,
		...
		{
			name: "custom spec with resource request - artifact not exist",
			modelSvc: &models.Service{
				Name:        models.CreateInferenceServiceName(model.Name, "1"),
				Namespace:   project.Name,
				ArtifactURI: model.ArtifactURI,
...
func TestPatchInferenceServiceSpec(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "custom spec - artifact exist",
			modelSvc: &models.Service{
				Name:        models.CreateInferenceServiceName(model.Name, "1"),
				Namespace:   project.Name,
				ArtifactURI: model.ArtifactURI,
		...
		{
			name: "custom spec - artifact not exist",
			modelSvc: &models.Service{
				Name:        models.CreateInferenceServiceName(model.Name, "1"),
				Namespace:   project.Name,
				ArtifactURI: model.ArtifactURI,
