...
import (
	...
	config "github.com/caraml-dev/merlin/config"
...
func (_m *VersionsService) Delete(version *models.Version) error {
	ret := _m.Called(version)

	var r0 error
	if rf, ok := ret.Get(0).(func(*models.Version) error); ok {
		r0 = rf(version)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *VersionsService) FindByID(ctx context.Context, modelID models.ID, versionID models.ID, monitoringConfig config.MonitoringConfig) (*models.Version, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.ID, models.ID, config.MonitoringConfig) (*models.Version, error)); ok {
		return rf(ctx, modelID, versionID, monitoringConfig)
	}
...
func (_m *VersionsService) ListVersions(ctx context.Context, modelID models.ID, monitoringConfig config.MonitoringConfig, query service.VersionQuery) ([]*models.Version, string, error) {
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, models.ID, config.MonitoringConfig, service.VersionQuery) ([]*models.Version, string, error)); ok {
		return rf(ctx, modelID, monitoringConfig, query)
	}
...
func (_m *VersionsService) Save(ctx context.Context, version *models.Version, monitoringConfig config.MonitoringConfig) (*models.Version, error) {
	...
	var r0 *models.Version
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.Version, config.MonitoringConfig) (*models.Version, error)); ok {
		return rf(ctx, version, monitoringConfig)
	}
...
type mockConstructorTestingTNewVersionsService interface {
	mock.TestingT
	Cleanup(func())
}

// NewVersionsService creates a new instance of VersionsService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewVersionsService(t mockConstructorTestingTNewVersionsService) *VersionsService {
	mock := &VersionsService{}
	mock.Mock.Test(t)
