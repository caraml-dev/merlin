						...
						Rules: []PromAlertRule{
							{
								...
								Expr: yamlv3.Node{
									...
									Style: yamlv3.LiteralStyle,
									Tag:   "!!str",
									Value: "(100 * sum(rate(container_cpu_usage_seconds_total{cluster_name=\"cluster-1\",namespace=\"project-1\",pod=~\".*model-1.*\"}[1m])) / sum(kube_pod_container_resource_requests_cpu_cores{cluster_name=\"cluster-1\",namespace=\"project-1\",pod=~\".*model-1.*\"})) > 50",
								},
								For: "5m",
								Labels: PromAlertRuleLabels{
									Owner:       "team-1",
						...
						Rules: []PromAlertRule{
							{
								...
								Expr: yamlv3.Node{
									...
									Style: yamlv3.LiteralStyle,
									Tag:   "!!str",
									Value: "(100 * sum(container_memory_usage_bytes{cluster_name=\"cluster-1\",namespace=\"project-1\",pod=~\".*model-1.*\"}) / sum(kube_pod_container_resource_requests_memory_bytes{cluster_name=\"cluster-1\",namespace=\"project-1\",pod=~\".*model-1.*\"})) > 50",
								},
								For: "5m",
								Labels: PromAlertRuleLabels{
									Owner:       "team-1",
