...
func (depl *ModelServiceDeployment) Deploy(job *queue.Job) error {
	...
	modelService := models.NewService(model, version, modelOpt, endpoint.ResourceRequest, endpoint.EnvVars, endpoint.EnvironmentName, endpoint.Transformer, endpoint.Logger, endpoint.DeploymentType)
