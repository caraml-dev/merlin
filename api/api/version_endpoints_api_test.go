...
func TestCreateEndpoint(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			desc: "Should success create endpoint with pyfunc_v3 model observability enabled",
			vars: map[string]string{
				"model_id":   "1",
				"version_id": "1",
			},
		...
		{
			desc: "Should failed create endpoint with non pyfunc_v3 and model observability enabled",
			vars: map[string]string{
				"model_id":   "1",
				"version_id": "1",
			},
			...
			expected: BadRequest("Request validation failed: model type should be pyfunc_v3 if want to enable model observablity"),
		},
		{
...
func TestUpdateEndpoint(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			desc: "Should success update endpoint, pyfunc_v3 and model observablity enabled",
			vars: map[string]string{
				"model_id":    "1",
				"version_id":  "1",
				"endpoint_id": uuid.String(),
		...
		},
		{
			...
			expected: &Response{
				code: http.StatusBadRequest,
				data: Error{Message: "Request validation failed: model type should be pyfunc_v3 if want to enable model observablity"},
			},
		},
		{
