...
def test_create_model(mock_url, api_client, mock_oauth):
    ...
    responses.add('GET', f"/api/v1/projects/{project_id}/models",
                  body='[]',
                  status=200,
                  content_type='application/json'
                  )
    responses.add('POST', f"/api/v1/projects/{project_id}/models",
                  body=f"""{{
                        "id": 0,
...
def test_get_model(mock_url, api_client, mock_oauth):
    ...
    responses.add("GET", f"/api/v1/models/1/endpoints",
...
def test_new_model_version(mock_url, api_client, mock_oauth):
    ...
    responses.add('POST', f"/api/v1/models/{model_id}/versions",
                  body=f"""{{
                        "id": {version_id},
                        "model_id": {model_id},
