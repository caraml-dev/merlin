...
from client.api import alert_api
...
*ModelSchemaApi* | [**models_model_id_schemas_post**](client/docs/ModelSchemaApi.md#models_model_id_schemas_post) | **POST** /models/{model_id}/schemas | Creating new schemas for a model
...
## Documentation For Models
 ...
 - [FreeFormObject](client/docs/FreeFormObject.md)
 - [GPUConfig](client/docs/GPUConfig.md)
 - [GPUToleration](client/docs/GPUToleration.md)
 - [InferenceSchema](client/docs/InferenceSchema.md)
