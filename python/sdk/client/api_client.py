...
from client.exceptions import ApiTypeError, ApiValueError, ApiException
from client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AlertApi()
        api_instance.alerts_teams_get  # this is an instance of the class Endpoint
        api_instance.alerts_teams_get()  # this invokes api_instance.alerts_teams_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.alerts_teams_get.callable or self.callable in this class
