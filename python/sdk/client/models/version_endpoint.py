...
class VersionEndpoint(object):
    ...
    swagger_types = {
        ...
        'protocol': 'Protocol',
        'enable_model_observability': 'bool',
        'created_at': 'datetime',
        'updated_at': 'datetime'
    }
    ...
    def __init__(self, id=None, version_id=None, status=None, url=None, service_name=None, environment_name=None, environment=None, monitoring_url=None, message=None, resource_request=None, image_builder_resource_request=None, env_vars=None, transformer=None, logger=None, deployment_mode=None, autoscaling_policy=None, protocol=None, enable_model_observability=None, created_at=None, updated_at=None):  # noqa: E501
        ...
        self._protocol = None
        self._enable_model_observability = None
        ...
        if enable_model_observability is not None:
            self.enable_model_observability = enable_model_observability
    ...
    @property
    def enable_model_observability(self):
        """Gets the enable_model_observability of this VersionEndpoint.  # noqa: E501


        :return: The enable_model_observability of this VersionEndpoint.  # noqa: E501
        :rtype: bool
        """
        return self._enable_model_observability

    @enable_model_observability.setter
    def enable_model_observability(self, enable_model_observability):
        """Sets the enable_model_observability of this VersionEndpoint.


        :param enable_model_observability: The enable_model_observability of this VersionEndpoint.  # noqa: E501
        :type: bool
        """

        self._enable_model_observability = enable_model_observability
