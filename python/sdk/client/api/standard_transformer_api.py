...
class StandardTransformerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __standard_transformer_simulate_post(
            self,
            **kwargs
        ):
            ...
            Keyword Args:
                body (StandardTransformerSimulationRequest): [optional]
        ...
        self.standard_transformer_simulate_post = _Endpoint(
            settings={
                'response_type': (StandardTransformerSimulationResponse,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/standard_transformer/simulate',
                'operation_id': 'standard_transformer_simulate_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__standard_transformer_simulate_post
        )
