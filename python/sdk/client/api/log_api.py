...
class LogApi(object):
    ...
    def logs_get_with_http_info(self, cluster, namespace, component_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('cluster' not in params or
                                                       params['cluster'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('component_type' not in params or
                                                       params['component_type'] is None):  # noqa: E501
