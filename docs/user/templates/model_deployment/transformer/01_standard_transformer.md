<!-- page-title: Standard Transformer -->
...
![Standard Transformer](../../../../images/standard_transformer.png)
...
For full list of standard transformer built-in functions, please check: {% page-ref page="./standard_transformer/01_standard_transformer_expressions.md" %}
...
![Configure Standard Transformer](../../../../images/configure_standard_transformer.gif)
...
{% code title="standard_transformer_deployment.py" overflow="wrap" lineNumbers="true" %}
```python
