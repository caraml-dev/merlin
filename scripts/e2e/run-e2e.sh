...
export MLP_API_BASEPATH="http://mlp.mlp.${INGRESS_HOST}/v1"
export MERLIN_API_BASEPATH="http://merlin.mlp.${INGRESS_HOST}"
...
pipenv run pytest -n=4 -W=ignore --cov=merlin -m "not (feast or batch or pytorch or pyfunc or local_server_test or cli or serving)"
